...
class CustomerMapperTest {
    ...
    private static final Customer EXPECTED_CUSTOMER_ENTITY_FROM_REQUEST =
            getCustomerEntitySample(MISSING_ID, VALID_CUSTOMER_EMAIL, getCustomerAddressEntitySample(STREET));

    private static final Customer EXPECTED_CUSTOMER_ENTITY_FROM_DTO =
            getCustomerEntitySample(VALID_ID, VALID_CUSTOMER_EMAIL, getCustomerAddressEntitySample(STREET));

    private static final CustomerDTO EXPECTED_CUSTOMER_DTO_FROM_REQUEST =
            getCustomerDTOSample(MISSING_ID, VALID_CUSTOMER_EMAIL, getUpdatedCustomerAddress(STREET));
    private static final CustomerDTO EXPECTED_CUSTOMER_DTO_FROM_ENTITY =
            getCustomerDTOSample(VALID_ID, VALID_CUSTOMER_EMAIL, getUpdatedCustomerAddress(STREET));
